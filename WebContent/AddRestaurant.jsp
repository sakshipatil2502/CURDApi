...
<br><br><br><br><br>
        <div class="section-title">
          <h2>Partner <span>With </span>Us</h2>
              </div>
      </div>
          ...
          <div class="text-center"><a href="RestaurantRegistration.jsp"><button class="book-a-table-btn" type="submit">Register your restaurant</button></a>
          <a href="RestaurantLogin.jsp"><button class="book-a-table-btn" type="submit">Login to view your existing restaurant</button></a>
