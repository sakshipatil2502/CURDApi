    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="ViewNotification.jsp">Notification</a></li>
    ...
    <section id="why-us" class="why-us">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Select Your <span>Favorite </span>Restaurant</h2>
          <p></p>
        </div>
...
<%
          ...
          <div class="col-lg-3">
            <div class="box">
              <span>
<td><img alt="Profile Pic" src="restaurantpic.jsp?id=<%=rs.getInt(1) %>"  width="205px" height="150px" /></td>
                  
</span>
              <h4><%=rs.getString(2)%></h4>
              <h8><%=rs.getString(7)%></h8>
              <h6><%=rs.getString(6)%></h6>
              <p> <center><button style="background-color:green;"><a style="color:white;" href="RestaurantDetails.jsp?rname=<%=rs.getString(2)%>"> View Menu</a></button>
              </center>
              </p>
            </div>
          </div>
