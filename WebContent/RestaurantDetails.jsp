...
<%
                ...
                String rname=request.getParameter("rname");
                    ...
                    Statement st=con.createStatement();
                     ResultSet rs=st.executeQuery("select * from addfood where rname='"+rname+"'"); 
                     while(rs.next()) {
                        	%>
                        	
          <div class="col-lg-6 menu-item filter-starters">
            <div class="menu-content">
              <a style="color:black;" href="#"><%=rs.getString(2)%><br>
              Rs.<%=rs.getString(4)%></a><span>
              <img alt="Profile Pic" src="foodpic.jsp?id=<%=rs.getInt(1) %>"  width="200px" height="100px" />
              <center><button style="background-color:green;"><a style="color:white; background-color:green;" href="FoodDetails.jsp?foodname=<%=rs.getString(2)%> & rname=<%=rs.getString(3)%>"> ADD</a></button>
              </center>
              </span>
            </div>
